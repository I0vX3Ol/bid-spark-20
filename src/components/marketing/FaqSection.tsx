...
export const faqs = [
  {
    ...
    a: "NexusDel aggregates publicly available procurement records from federal, state and local sources, normalizes them into a single schema, and enriches each record with AI analysis. Every record links back to its originating source.",
  },
  {
