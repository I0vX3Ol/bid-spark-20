...
export const Route = createFileRoute("/legal/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Service | NexusDel" },
      {
        name: "description",
        content:
          "The terms that govern use of the NexusDel platform, including acceptable use, subscriptions and data accuracy disclaimers.",
      },
      { property: "og:title", content: "NexusDel Terms of Service" },
      { property: "og:description", content: "Terms governing use of the NexusDel platform." },
...
const sections = [
  {
    ...
    body: "You may use NexusDel for lawful business purposes. You are responsible for the security of your account credentials and for activity performed under your account.",
  },
  {
