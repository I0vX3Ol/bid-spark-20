...
export const Route = createFileRoute("/pricing")({
  head: () => ({
    meta: [
      { title: "Pricing — Procurement Intelligence Plans | NexusDel" },
      {
        name: "description",
        content:
          "Compare NexusDel plans: free opportunity search, Professional alerts and AI analysis, and Enterprise workspaces with API access and SSO.",
      },
      { property: "og:title", content: "NexusDel Pricing" },
      {
      ...
      <section className="container-page pb-20">
        ...
        <div className="mt-6 overflow-x-auto rounded-2xl border border-border">
          <table className="w-full min-w-[36rem] border-collapse text-sm">
            <caption className="sr-only">Feature comparison across NexusDel plans</caption>
            <thead>
